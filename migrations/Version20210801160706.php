...
final class Version20210801160706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_skill (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, skill_id INT NOT NULL, base INT DEFAULT NULL, INDEX IDX_6C0E9DF8E48FD905 (game_id), INDEX IDX_6C0E9DF85585C142 (skill_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
