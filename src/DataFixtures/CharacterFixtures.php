...
class CharacterFixtures extends Fixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $tabCharac = [
            ...
            ['Tabita Of Ness', 'tabita.jpg', 'F', 'Gaucher', '', '', '', '22', '', '', true, 'Chaos 0 - Balance 0 - Loi 3', '', '', '570', 'game1'],
            ['Bort Of Pikarayd', 'bort.jpg', 'M', 'Gaucher', '', '', '', '21', '', '', true, 'Chaos 3 - Balance 0 - Loi 0', '', '', '220', 'game1'],
            ['Rathek', 'rathek.jpg', 'M', 'Droitier', '', '', '', '25', '', '', true, 'Chaos 0 - Balance 3 - Loi 0', '', '', '2100', 'game1'],
            ['Vreen', 'vreen.jpg', 'F', 'Droitier', '', '', '', '19', '', '', true, 'Chaos 0 - Balance 3 - Loi 0', '', '', '660', 'game1'],
            ['Kevi', 'kevi.jpg', 'F', 'Droitier', '', '', '', '20', '', '', true, 'Chaos 3 - Balance 0 - Loi 0', '', '', '160', 'game1'],
            ...
            ['Ilia Droudji', 'ilia.jpg', 'F', '', '1m63', '49kg', 'Avec  sa  longue  chevelure  noire,  sa  dé-
