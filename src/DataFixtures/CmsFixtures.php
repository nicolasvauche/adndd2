...
class CmsFixtures extends Fixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        Site Web : <a href="http://https://www.adndd.fr">https://www.adndd.fr</a>
        </br></p>
        ...
        Site Web :  <a href="http://https://www.o2switch.fr/">https://www.o2switch.fr/</a></p>
        </br>
        <p style="color: #b51a00;"><span style="color: rgb(0, 0, 0);"><b>Développement</b><b> : </b></span></p>
        <p>Smart Pixels
        Adresse : 50 Boulevard Gambetta, 87000 Limoges
        Site Web : <a href="http://www.smartpixels.com">www.smartpixels.com</a></p>
        </br>
        <p style="color: #b51a00;"><span style="color: rgb(0, 0, 0);"><b>Conditions d’utilisation : </b></span></p>
        <p>Ce site (<a href="http://https://www.adndd.fr">https://www.adndd.fr</a>) est proposé en différents langages web (HTML, HTML5, Javascript, CSS, etc…) pour un meilleur confort d\'utilisation et un graphisme plus agréable, nous vous recommandons de recourir à des navigateurs modernes comme Internet explorer, Safari, Firefox, Google Chrome, etc…
        ...
        <span style="color: #323333;">ALIPTIC<b> </b></span>met en œuvre tous les moyens dont elle dispose, pour assurer une information fiable et une mise à jour fiable de ses sites internet. Toutefois, des erreurs ou omissions peuvent survenir. L\'internaute devra donc s\'assurer de l\'exactitude des informations auprès de , et signaler toutes modifications du site qu\'il jugerait utile. n\'est en aucun cas responsable de l\'utilisation faite de ces informations, et de tout préjudice direct ou indirect pouvant en découler.
        
        <b>Cookies</b> : Le site <a href="http://https://www.adndd.fr">https://www.adndd.fr</a> peut-être amené à vous demander l’acceptation des cookies pour des besoins de statistiques et d\'affichage. Un cookies est une information déposée sur votre disque dur par le serveur du site que vous visitez. Il contient plusieurs données qui sont stockées sur votre ordinateur dans un simple fichier texte auquel un serveur accède pour lire et enregistrer des informations . Certaines parties de ce site ne peuvent être fonctionnelles sans l’acceptation de cookies.
        
        <b>Liens hypertextes :</b> Les sites internet de peuvent offrir des liens vers d’autres sites internet ou d’autres ressources disponibles sur Internet. ALIPTIC ne dispose d\'aucun moyen pour contrôler les sites en connexion avec ses sites internet. ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit. Elle ne peut être tenue pour responsable de tout dommage, de quelque nature que ce soit, résultant du contenu de ces sites ou sources externes, et notamment des informations, produits ou services qu’ils proposent, ou de tout usage qui peut être fait de ces éléments. Les risques liés à cette utilisation incombent pleinement à l\'internaute, qui doit se conformer à leurs conditions d\'utilisation.
        ...
        <p style="color: #323333;">L\'ensemble des activités de la société ainsi que ses informations sont présentés sur notre site <a href="http://https://www.adndd.fr">https://www.adndd.fr</a>.</p>
        <p style="color: #323333;">ALIPTIC s’efforce de fournir sur le site https://www.adndd.fr des informations aussi précises que possible. les renseignements figurant sur le site <a href="http://https://www.adndd.fr">https://www.adndd.fr</a> ne sont pas exhaustifs et les photos non contractuelles. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Par ailleurs, tous les informations indiquées sur le site https://www.adndd.fr<span style="color: #000000;"><b> </b></span>sont données à titre indicatif, et sont susceptibles de changer ou d’évoluer sans préavis.  </p>
        </br>
        ...
        Les liens hypertextes mis en place dans le cadre du présent site internet en direction d\autres ressources présentes sur le réseau Internet ne sauraient engager la responsabilité de ALIPTIC.</p>
        </br>
        <p style="color: #b51a00;"><span style="color: rgb(0, 0, 0);"><b>Propriété intellectuelle :</b></span></p>
        <p>Tout le contenu du présent sur le site <a href="http://https://www.adndd.fr">https://www.adndd.fr</a>, incluant, de façon non limitative, les graphismes, images, textes, vidéos, animations, sons, logos, gifs et icônes ainsi que leur mise en forme sont la propriété exclusive de la société à l\'exception des marques, logos ou contenus appartenant à d\'autres sociétés partenaires ou auteurs.
        ...
        $cms1->setMedia("cms1.jpg");
        $cms1->setCreatedAt(new \DateTime());
        $cms1->setUpdatedAt(new \DateTime());

        $manager->persist($cms1);

        $cms2 = new CMS();
        $cms2->setTitle('conditions d\'utilisation');
        $cms2->setContent('<h1>Website Terms and Conditions of Use</h1>
        ...
        $cms2->setMedia("cms2.jpg");
        $cms2->setCreatedAt(new \DateTime());
        $cms2->setUpdatedAt(new \DateTime());

        $manager->persist($cms2);

        $cms3 = new CMS();
        $cms3->setTitle('politique de confidentialité');
        $cms3->setContent('<p>
                      ...
                      </p> <!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----></ul></div> <p><strong>Log Data</strong></p> <p>
                    ...
                    </p> <p><ul><li>To facilitate our Service;</li> <li>To provide the Service on our behalf;</li> <li>To perform Service-related services; or</li> <li>To assist us in analyzing how our Service is used.</li></ul> </p><p>
                      ...
                      this page.
                    </p> <p>This policy is effective as of 2021-07-01</p> <p><strong>Contact Us</strong></p> <p>
                      If you have any questions or suggestions about our
                      Privacy Policy, do not hesitate to contact us at contact@adndd.fr.</p>
          ');
        $cms3->setType("legal");
        $cms3->setIsActive(true);        
        $cms3->setMedia("cms3.jpg");
        $cms3->setCreatedAt(new \DateTime());
        $cms3->setUpdatedAt(new \DateTime());

        $manager->persist($cms3);

        $cms4 = new CMS();
        $cms4->setTitle('association');
        $cms4->setContent('<p> L\'association “Ah ! D & Dédé !” est un club de jeu de rôles qui existe depuis septembre 2018, sous la forme d’une association loi 1901. La majorité des jeux couverts par l’association sont des jeux de rôles sur table appartenant en grande partie à ses membres. Elle propose également quelques jeux de société qu\'elle possède.</p>
        ...
        $cms4->setMedia("cms4.jpg");
        $cms4->setCreatedAt(new \DateTime());
        $cms4->setUpdatedAt(new \DateTime());
